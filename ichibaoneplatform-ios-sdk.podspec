#
#  Be sure to run `pod spec lint ichibaoneplatform-ios-sdk.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                        Swift SDK to handle tracking, APNs and Firebase Cloud Messaging
                   DESC

  spec.homepage     = "https://github.com/ICHIBAONE-PLATFORM/ichibaoneplatform-ios-sdk"
  ...
  spec.source       = { :git => "https://github.com/ICHIBAONE-PLATFORM/ichibaoneplatform-ios-sdk.git", :tag => "#{spec.version}" }
